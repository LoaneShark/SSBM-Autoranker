	...
	if print_res:
		...
		if len(p_list) > 0:
			...
			if mode == 'dict':
				...
				if sig_mode == 'alt':
					intsig_res = [[data_dict[p_id][0],skill,inv_alt_sigmoid(0.5,(sig[0],sig[1],sig[2],sig[3])),p_id] for skill,sig,p_id in zip(new_data,sigs,id_list)]
				else:
